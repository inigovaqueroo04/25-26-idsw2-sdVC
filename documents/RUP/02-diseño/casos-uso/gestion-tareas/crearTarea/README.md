...
| Caso de uso relacionado | crearTarea() |
| Módulo funcional | Gestión de tareas |

## Propósito

Diseñar el alta de una tarea dentro de un grupo, con datos mínimos de planificación.
...
| Coordinador del caso de uso | Control | Ordena el flujo de crearTarea() y decide qué servicio invocar. |
...
| Entidades de dominio implicadas | Dominio | Tarea, Grupo, Horario, Localizacion, Recordatorio, ConflictoHorario. |

## Decisiones de diseño

- Datos necesarios: título, grupo, fecha, horario, asignaciones opcionales y descripción.
- Entidades afectadas: Tarea, Grupo, Horario, Localizacion, Recordatorio, ConflictoHorario.
- Cambios de estado: TAREAS_ABIERTO, TAREA_ABIERTO.
...
- Decisión específica: Una tarea guardada con horario válido se considera planificada; los conflictos se registran sin bloquear necesariamente la creación.
...
1. El usuario solicita crearTarea() desde la interfaz.
...
TAREAS_ABIERTO, TAREA_ABIERTO

## Validaciones

- El grupo debe existir y ser accesible.
- El título debe ser válido.
- El horario debe ser coherente.
- Las asignaciones deben pertenecer al grupo.
...
- Horario inválido.
- Grupo no accesible.
- Fallo al guardar tarea.

## Resultado esperado

La tarea queda creada y disponible para seguimiento, asignación y planificación.

## Trazabilidad

| Elemento de análisis usado | Decisión de diseño derivada | Entidad o módulo afectado | Estado |
| --- | --- | --- | --- |
| [README de análisis](../../../../01-analisis/casos-uso/gestion-tareas/crearTarea/README.md) | Convertir el comportamiento funcional en colaboración entre interfaz, coordinador y servicios conceptuales. | Gestión de tareas | diseñado |
| [Diagrama de colaboración](../../../../01-analisis/casos-uso/gestion-tareas/crearTarea/colaboracion.puml) | Mantener separación entre límite, control y dominio sin fijar tecnología. | CoordinadorCrearTarea, ServicioAplicacion, ServicioDominio | diseñado |
| [Secuencia de análisis](../../../../01-analisis/casos-uso/gestion-tareas/crearTarea/secuencia.puml) | Preservar orden de interacción y estados principales. | EstadoAplicacion, Tarea, Grupo, Horario, Localizacion, Recordatorio, ConflictoHorario | diseñado |
...
participant "CoordinadorCrearTarea" as Coordinador
...
Usuario -> Interfaz : solicita crearTarea()
Interfaz -> Coordinador : enviar datos de entrada
Coordinador -> ServicioAplicacion : ejecutar crearTarea()
ServicioAplicacion -> ServicioDominio : validar reglas del caso
ServicioDominio -> Repositorio : consultar Tarea, Grupo, Horario, Localizacion, Recordatorio, ConflictoHorario
