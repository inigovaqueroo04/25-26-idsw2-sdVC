...
Diseñar el cierre funcional de una tarea al completarse.
...
| Coordinador del caso de uso | Control | Ordena el flujo de marcarCompletada() y decide qué servicio invocar. |
...
| Entidades de dominio implicadas | Dominio | Tarea, Usuario, MiembroGrupo. |

## Decisiones de diseño

- Datos necesarios: tarea seleccionada, usuario que completa y fecha de completado.
- Entidades afectadas: Tarea, Usuario, MiembroGrupo.
- Cambios de estado: TAREA_ABIERTO, TAREAS_ABIERTO, TAREA_COMPLETADA.
...
- Decisión específica: Completar modifica el estado de la tarea, no elimina la tarea ni sus relaciones históricas.
...
1. El usuario solicita marcarCompletada() desde la interfaz.
...
TAREA_ABIERTO, TAREAS_ABIERTO, TAREA_COMPLETADA
...
- Fallo al actualizar estado.

## Resultado esperado

La tarea queda marcada como completada y conserva trazabilidad del cierre.

## Trazabilidad

| Elemento de análisis usado | Decisión de diseño derivada | Entidad o módulo afectado | Estado |
| --- | --- | --- | --- |
| [README de análisis](../../../../01-analisis/casos-uso/gestion-tareas/marcarCompletada/README.md) | Convertir el comportamiento funcional en colaboración entre interfaz, coordinador y servicios conceptuales. | Gestión de tareas | diseñado |
| [Diagrama de colaboración](../../../../01-analisis/casos-uso/gestion-tareas/marcarCompletada/colaboracion.puml) | Mantener separación entre límite, control y dominio sin fijar tecnología. | CoordinadorMarcarCompletada, ServicioAplicacion, ServicioDominio | diseñado |
| [Secuencia de análisis](../../../../01-analisis/casos-uso/gestion-tareas/marcarCompletada/secuencia.puml) | Preservar orden de interacción y estados principales. | EstadoAplicacion, Tarea, Usuario, MiembroGrupo | diseñado |
...
Usuario -> Interfaz : solicita marcarCompletada()
Interfaz -> Coordinador : enviar datos de entrada
Coordinador -> ServicioAplicacion : ejecutar marcarCompletada()
ServicioAplicacion -> ServicioDominio : validar reglas del caso
ServicioDominio -> Repositorio : consultar Tarea, Usuario, MiembroGrupo
