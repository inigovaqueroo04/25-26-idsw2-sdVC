...
| Caso de uso relacionado | relacionarTareas() |
| Módulo funcional | Gestión de tareas |

## Propósito

Diseñar la creación o modificación de relaciones entre tareas.
...
| Coordinador del caso de uso | Control | Ordena el flujo de relacionarTareas() y decide qué servicio invocar. |
...
| Entidades de dominio implicadas | Dominio | Tarea, RelacionTareas, Grupo. |

## Decisiones de diseño

- Datos necesarios: tarea origen, tarea destino y tipo de relación.
- Entidades afectadas: Tarea, RelacionTareas, Grupo.
...
- Decisión específica: Se separan conceptualmente subtareas y relaciones de precedencia aunque puedan gestionarse desde el mismo flujo.
...
1. El usuario solicita relacionarTareas() desde la interfaz.
...
- Ambas tareas deben existir.
- Las tareas deben pertenecer a un contexto compatible.
- No debe crearse una relación circular inválida.
- El tipo de relación debe estar permitido.

## Excepciones o errores

- Tarea origen o destino inexistente.
- Relación duplicada.
...
Queda registrada la relación de jerarquía o precedencia entre tareas.

## Trazabilidad

| Elemento de análisis usado | Decisión de diseño derivada | Entidad o módulo afectado | Estado |
| --- | --- | --- | --- |
| [README de análisis](../../../../01-analisis/casos-uso/gestion-tareas/relacionarTareas/README.md) | Convertir el comportamiento funcional en colaboración entre interfaz, coordinador y servicios conceptuales. | Gestión de tareas | diseñado |
| [Diagrama de colaboración](../../../../01-analisis/casos-uso/gestion-tareas/relacionarTareas/colaboracion.puml) | Mantener separación entre límite, control y dominio sin fijar tecnología. | CoordinadorRelacionarTareas, ServicioAplicacion, ServicioDominio | diseñado |
| [Secuencia de análisis](../../../../01-analisis/casos-uso/gestion-tareas/relacionarTareas/secuencia.puml) | Preservar orden de interacción y estados principales. | EstadoAplicacion, Tarea, RelacionTareas, Grupo | diseñado |
...
participant "CoordinadorRelacionarTareas" as Coordinador
...
Usuario -> Interfaz : solicita relacionarTareas()
Interfaz -> Coordinador : enviar datos de entrada
Coordinador -> ServicioAplicacion : ejecutar relacionarTareas()
ServicioAplicacion -> ServicioDominio : validar reglas del caso
ServicioDominio -> Repositorio : consultar Tarea, RelacionTareas, Grupo
